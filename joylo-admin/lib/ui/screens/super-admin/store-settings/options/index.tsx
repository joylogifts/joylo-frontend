...
import OptionsHeader from '@/lib/ui/screen-components/protected/super-admin/options/view/header/screen-header';
import OptionsMain from '@/lib/ui/screen-components/protected/super-admin/options/view/main';
