...
// Components
import AddonsAddForm from '@/lib/ui/screen-components/protected/super-admin/add-on/add-form';
import AddonsHeader from '@/lib/ui/screen-components/protected/super-admin/add-on/view/header/screen-header';
import AddonsMain from '@/lib/ui/screen-components/protected/super-admin/add-on/view/main';
