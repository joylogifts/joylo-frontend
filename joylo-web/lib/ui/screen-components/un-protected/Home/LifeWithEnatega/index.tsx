  ...
  return (
    <div className="mt-[80px] mb-[80px]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 ">
        ...
        <MoveableCard
          image={ZeroDelivery}
          heading={"0 € delivery fees with Joylo"}
          subText={
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-[30px] mb-[30px]">
        <HomeCard image={CustomerApp} heading={"Fresh Groceries Delivered"} subText={"Go to Joylo App"} link={"https://play.google.com/store/apps/details?id=com.enatega.multivendor&hl=en"}/>
        <HomeCard image={RestaurantApp} heading={"Restaurants Earn More"} subText={"Go to Joylo Restaurant App"} link={"https://play.google.com/store/apps/details?id=multivendor.enatega.restaurant&hl=en"} />
        <HomeCard image={RiderApp} heading={"Riders Reaches Fast"} subText={"Go to Joylo Rider App"} link={"https://play.google.com/store/apps/details?id=com.enatega.multirider&hl=en"}/>
      </div>
    </div>
  );
};
