        ...
        return (
            <div className="p-6 w-full bg-white rounded-lg border border-gray-200 shadow-sm">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div className="relative h-16 w-16 flex-shrink-0 bg-[#FFDBBB] rounded-full border-2 border-white shadow-sm shadow-gray-400">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            <TextComponent
                                text={getTranslation("phone_number_label")}
                                className="text-black font-semibold text-base md:text-lg"
                            />
                            <i
                                onClick={handleUpdatePhoneModal}
                                className="pi pi-pen-to-square cursor-pointer text-sm"
                            ></i>
                        </div>
                        <h1
                            onClick={handleUpdatePhoneModal}
