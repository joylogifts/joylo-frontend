        ...
        >
            <div className="flex flex-col items-center md:p-6 p-0 pt-16 rounded-xl gap-4">
                    ...
                    {order?.restaurant?.image ? (
                        ...
                        <div className="w-full h-full bg-gray-200 flex items-center justify-center">
                            <img
                                ...
                                alt={getTranslation("restaurant_label")}
                                className="w-full h-full object-cover"
                            />
                        </div>
                    )}
                ...
                <p className="text-gray-600 ">
                    {order?.restaurant?.name ||
                        getTranslation("restaurant_name_label")}
                </p>

                {/* Modal Title */}
                <h2 className="md:text-2xl text-xl font-bold  text-black">
                    {getTranslation("how_was_the_delivery_title")}
                </h2>

                {/* Modal Description */}
                <p className="text-gray-600  text-center md:text-lg text-base">
                    {getTranslation("rating_modal_description")}
                </p>
