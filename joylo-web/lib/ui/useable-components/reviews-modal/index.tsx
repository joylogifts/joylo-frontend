...
const ReviewsModal = ({
    ...
    const hasReviews =
        reviewResult.total > 0 && reviewResult.reviews.length > 0;
                ...
                {hasReviews ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-10 text-center">
                        ...
                        <h2 className="text-2xl font-semibold text-gray-800 mb-2">
                            {getTranslation("no_reviews_yet")}
                        </h2>
                        <p className="text-gray-600 max-w-md mb-6">
                            {getTranslation("no_reviews_yet_description")}
                        </p>
                    </div>
                )}
            </div>
