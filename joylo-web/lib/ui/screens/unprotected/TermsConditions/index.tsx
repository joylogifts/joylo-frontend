...
const ParasData = [
  {
    ...
    head: "TERMS OF USE",
    paras: [
      "These Terms of Use (“Terms”) govern your use of the websites and mobile applications provided by joylo (collectively the “Platforms”). Please read these Terms carefully. By accessing and using the Platforms, you agree that you have read, understood and accepted the Terms including any additional terms and conditions and any policies referenced herein, available on the Platforms or available by hyperlink. If you do not agree or fall within the Terms, please do not use the Platforms.",
      ...
      "Joylo reserves the right to change or modify these Terms (including our policies which are incorporated into these Terms) at any time. You are strongly recommended to read these Terms regularly. You will be deemed to have agreed to the amended Terms by your continued use of the Platforms following the date on which the amended Terms are posted.",
    ],
  },

  {
    number: "2.",
    head: "Use of the Platforms and joylo Account",
    paras: [
      "You will need to register for a joylo account for you to use the Platform. When you register for a joylo account we will ask you to provide your personal information including a valid email address, a mobile phone number and a unique password. To purchase an Order, depending on which payment method you opt for, you may need to provide us with your credit card details. Your unique password should not be shared with anyone and you agree to keep it secret at all times. You are solely responsible for keeping your password safe. Save for cases of fraud or abuse which are not your fault, you accept that all Orders placed under your joylo account are your sole responsibility.",
      "joylo shall not be liable for Orders that encounter delivery issues due to incomplete, incorrect or missing information provided by you. You are obliged to provide information that is complete, accurate and truthful for the proper processing of the Order, including your delivery address and contact information.",
      "If you wish to delete your joylo account, please send us an email requesting the same. We may restrict, suspend or terminate your joylo account and/or use of the Platforms, if we reasonably believe that:",
      "someone other than you is using your joylo account; or where you are suspected or discovered to have been involved in any activity or conduct that is in breach of these Terms, our policies and guidelines, or involved in activity or conduct which we deem in our sole discretion to be an abuse of the Platforms.",
    ],
  },
  {
    number: "3.",
    ...
    paras: [
      "All trademarks, logos, images, and service marks, including these Terms as displayed on the Platforms or in our marketing material, whether registered or unregistered, are the intellectual property of joylo and/or third parties who have authorised us with the use (collectively the “Trademarks”). You may not use, copy, reproduce, republish, upload, post, transmit, distribute, or modify these Trademarks in any way without our prior express written consent. The use of joylo's trademarks on any other website not approved by us is strictly prohibited. Joylo will aggressively enforce its intellectual property rights to the fullest extent of the law, including criminal prosecution. Joylo neither warrants nor represents that your use of materials displayed on the Platforms will not infringe rights of third parties not owned by or affiliated with oylo. Use of any materials on the Platforms is at your own risk.",
    ],
  },
  {
    number: "4. ",
    ...
    paras: [
      "Vendors are responsible for the preparation, condition and quality of Goods. In cases of Vendor Delivery, Vendors are responsible for delivery of the Goods and/or Orders. Joylo shall not be liable for any loss or damage arising from your contractual relationship with the Vendor.",
    ],
  },
  {
    number: "5.",
  ...
  },
  {
    ...
    head: "Indemnity",
    paras: [
      "You agree to indemnify, defend, hold harmless joylo, its directors, officers, employees, representatives, agents, and affiliates, from any and all third party claims, liability, damages and/or costs (including but not limited to, legal fees) arising from your use of the Platforms or your breach of these Terms.",
    ],
  },
  {
    number: "7.",
    ...
    paras: [
      "The Platforms may contain links to other third party websites and by clicking on these links, you agree to do so at your own risk. Joylo does not control or endorse these third party websites or links and shall not be responsible for the content of these linked pages. Joylo accepts no liability or responsibility for any loss or damage which may be suffered by you in relation to your access and use of these third party links and websites.",
    ],
  },
  {
    number: "8.",
    head: "Termination",
    paras: [
      "Joylo has the right to terminate, suspend or delete your account and access to the Platforms, including any delivery service we provide to you in respect of an Order, for any reason, including, without limitation, if joylo, in its sole discretion, considers your use to be unacceptable, or in the event of any breach by you of the Terms. Joylo may, but shall be under no obligation to, provide you a warning prior to termination of your use of the Websites.",
    ],
  },
  {
    number: "9.",
...
const ListDatas = [
  {
    ...
    list: [
      {
        text: 'What we do Through our Platforms, joylo links you to the vendors (“Vendors”) for you to order a variety of goods including prepared meals, non-prepared food and miscellaneous non-food items (hereinafter collectively referred to as "Goods") to be delivered to you. When you place an order for Goods from our Vendors (“Order”), joylo acts as an agent on behalf of that Vendor to facilitate, process and conclude the order and subsequently for either us or the Vendor to deliver your Order to you. Vendors may be owned and operated by third party vendors, our affiliate companies, or us.',
        subList: [],
      },
      {
...

  {
    ...
    list: [
      ...
      {
        text: "posting content that is unlawful, obscene, defamatory, threatening, harassing, abusive, slanderous, hateful, or embarrassing to any other person or entity as determined by Joylo in its sole discretion or pursuant to local community standards",
        subList: [],
      },
      {
        text: "posting content that constitutes cyber-bullying, as determined by joylo in its sole discretion",
        subList: [],
      },
      {
      ...
      {
        text: "posting anything that may be “spam,” as determined by joylo in its sole discretion",
        subList: [],
      },
      {
      ...
      {
        text: "suspend or terminate a user’s access to the Platforms or their joylo Account upon any breach of these Terms",
        subList: [],
      },
      {
...

  {
    ...
    list: [
      ...
      {
        text: "Alcohol / Alcoholic Products (“Alcohol”) To purchase Alcohol, you must be of the statutory legal age. Joylo, the Vendor and their delivery riders, as the case may be, reserve the right in their sole discretion",
        subList: [],
      },
      {
      ...
      {
        text: "To purchase Tobacco, you must be of the statutory legal age. Joylo, the Vendor and their delivery riders, as the case may be, reserve the right in their sole discretion:",
        subList: [
...

  {
    ...
    list: [
      {
        text: "When you place an Order with joylo, joylo will confirm your order by sending you a confirmation email containing the Order receipt. Where applicable, Orders will include delivery fees and any applicable tax (e.g. goods and services tax, value-added tax, etc.).",
        subList: [],
      },
      {
      ...
      {
        text: "Special Instructions – joylo and the Vendor (as the case may be) reasonably endeavour to comply with your special instructions for an Order. However in some cases where this is not feasible, possible or commercially reasonable, joylo and/or the Vendor reserve the right to proceed to prepare the Order in accordance with standard operating procedures. Neither joylo nor the Vendor shall be responsible to replace or refund an Order which does not conform to special instructions provided by you",
        subList: [],
      },
      {
        text: "Allergens – joylo is not obligated to provide ingredient information or allergen information on the Platforms. Further, joylo does not guarantee that the Goods sold by Vendors are free of allergens. If you have allergies, allergic reactions or dietary restrictions and requirements, please contact the Vendor before placing an Order on our Platforms.",
        subList: [],
      },
      {
...

  {
    ...
    list: [
      ...
      {
        text: "If you have existing credit in your Joylo account or valid promotional or discount vouchers, you can use this to pay for part or all of your Order as the case may be.",
      },
    ],
  },
  {
    ...
    paras: [
      ...
      "In some cases, our Vendors will deliver the Order to you ('Vendor Delivery'). While we will use reasonable efforts to provide prior notice to you on Vendor Delivery, this may not always be possible. Where Vendor Delivery applies, we may ask you to contact the Vendor directly in the event of issues or delays in your delivery. Joylo shall not be responsible in any way for Orders or Goods that are delivered by Vendors.",
    ],
    list: [
      ...
      {
        text: "You remain uncontactable or fail to receive the Order within 10 minutes from its arrival at your delivery address. Joylo may cancel the Order without refund or remedy.",
      },
      ...
      {
        text: "Joylo may request photographic proof or additional information for investigation.",
      },
      {
        text: "If the Order is deemed unsatisfactory, Joylo will compensate for all or part of your Order.",
      },
    ],
  },
  {
    ...
    paras: [
      "From time to time, Joylo may run marketing and promotional campaigns which offer voucher codes, discounts, and other promotional offers to be used on the Platforms ('Vouchers'). Vouchers are subject to validity periods, redemption periods, and in certain cases, may only be used once.",
    ],
    list: [
      {
      ...
      {
        text: "Joylo reserves the right to void, discontinue or reject the use of any Voucher without prior notice.",
      },
...

  {
    ...
    paras: [
      "You acknowledge and agree that the content on the Platforms are provided on an “as is” and “as available” basis, and that your use of or reliance upon the Platforms and any content, goods, products or services accessed or obtained thereby is at your sole risk and discretion. While Joylo makes reasonable efforts to ensure the provision of the Platforms and the services we offer are available at all times, we do not warrant or represent that the Platforms shall be provided in a manner which is secure, timely, uninterrupted, error-free, free of technical difficulties, defects or viruses. Please expect temporary interruptions of the Platform due to scheduled or regular system maintenance work, downtimes attributable to internet or electronic communications, or events of force majeure.",

      "To the extent permitted by law, Joylo (which shall include its employees, directors, agents, representatives, affiliates, and parent company) exclude all liability (whether arising in contract, in negligence or otherwise) for loss or damage which you or any third party may incur in connection with our Platforms, our services, and any website linked to our Platforms and any content or material posted on it. Your exclusive remedy with respect to your use of the Platforms is to discontinue your use of the Platforms. The Joylo entities, their agents, representatives, and service providers shall not be liable for any indirect, special, incidental, consequential, or exemplary damages arising from your use of the Platforms or for any other claim related in any way to your use of the Platforms. These exclusions for indirect, special, consequential, and exemplary damages include, without limitation, damages for lost profits, lost data, loss of goodwill, work stoppage, computer failure, or malfunction, or any other commercial damages or losses, even if the Joylo entities, their agents, representatives, and service providers have been advised of the possibility thereof and regardless of the legal or equitable theory upon which the claim is based. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, Joylo, the Joylo entities, its agents, representatives and service providers' liability shall be limited to the extent permitted by law.",

      "Joylo shall neither be liable for actions or omissions of the Vendor nor you in regard to provision of the Goods and where Vendor Delivery applies to your Order. Joylo does not assume any liability for the quantity, quality, condition or other representations of the Goods and/or services provided by Vendors or guarantee the accuracy or completeness of the information (including menu information, photos and images of the Goods) displayed on the Vendor’s listing/offering on the Platform. Nothing in these Terms shall exclude Vendor’s liability for death or personal injury arising from Vendor’s gross negligence or willful misconduct.",
    ],
    list: [],
  },
];
