const de = {
  translation: {
    ...
    vendorDescription:
      "Erweitern Sie Ihre Reichweite, gewinnen Sie mehr Kunden und bauen Sie stärkere Verbindungen in jedem Viertel auf. Werden Sie noch heute ein Joylo-Anbieter!",
