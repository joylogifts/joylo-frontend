const en = {
  translation: {
    ...
    saveButton: "Save",
    footerText:
      "Joylo is an open-source delivery management platform for the future. We prioritize innovation, flexibility, and affordability, and offer a scalable, customizable solution that streamlines your delivery processes.",
    footerLinkHome: "Home",
    footerLinkPP: "Privacy Policy",
    footerLinkTC: "Terms & Conditions",
    footerEndText: "Joylo – © 2022 All Rights Reserved",
    followUs: "Follow Us",
    ...
    createAccount: "Create your Joylo Account",
    ...
    orderSubText1:
      "Experience the convenience of having all your favorite restaurant meals and cuisines in one place, delivered straight to your door—fast and fresh. Download the Joylo App today, and turn every craving into a delicious reality.",
    orderSubText2:
      "Explore a wide range of options, from local favorites and comfort food to gourmet dishes, healthy eats, and more.",
    orderSubText3:
      "Download the Joylo App today, and turn every craving into a delicious reality.",
    ...
    vendorDescription:
      "Expand your reach, attract more customers, and build stronger connections in every neighborhood. Join Joylo as a vendor today!",
