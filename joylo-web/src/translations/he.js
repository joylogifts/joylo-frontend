const he = {
  translation: {
    ...
    orderSubText1:
      "חווה את הנוחות של having all your favorite restaurant meals and cuisines in one place, delivered straight to your door—fast and fresh. הורד את אפליקציית Joylo היום, והפוך כל חשק למאכל טעים למציאות.",
    orderSubText2:
      "גלה מגוון רחב של אפשרויות, ממנות אהובות מקומיות ואוכל מנחם ועד מנות גורמה, אוכל בריא ועוד.",
    orderSubText3:
      "הורד את אפליקציית Joylo היום, והפוך כל חשק למאכל טעים למציאות.",
    ...
    vendorDescription:
      "הרחב את טווח ההגעה שלך, משוך יותר לקוחות ובנה קשרים חזקים יותר בכל שכונה. הצטרף ל-Joylo כספק היום!",
    ...
    emailConfirmationDescription:
      "אנו נרגשים לקבל אותך אלינו כשמטרתנו היא לשפר את השירותים בתחום המשלוחים עבור כולם. כשותף משלוחים/איסוף, תוכל לעבוד לפי לוח הזמנים שלך בכל מקום ובכל זמן. זקוק לעזרה? שלח לנו מייל ל-joylogifts@gmail.com",
    getStarted: "התחל עכשיו",
    thankyouPageHeading: "האימייל שלך נשלח בהצלחה!",
    thankyouPageDescription:
      "חבר מצוותנו ייצור קשר איתך בקרוב כדי לעזור לך בהגדרה ולהשיב על כל שאלה שיש לך. זקוק לעזרה? שלח לנו מייל ל-joylogifts@gmail.com",
