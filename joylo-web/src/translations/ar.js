const ar = {
  translation: {
    ...
    orderSubText1:
      "استمتع براحة الحصول على جميع وجبات ومأكولات المطاعم المفضلة لديك في مكان واحد، مع توصيلها مباشرة إلى باب منزلك بسرعة وطازجة. قم بتنزيل تطبيق Joylo اليوم، وحقق كل رغبة في تناول الطعام إلى حقيقة لذيذة.",
    orderSubText2:
      "استكشف مجموعة واسعة من الخيارات، من المفضلات المحلية والطعام المريح إلى الأطباق الراقية، الأطعمة الصحية والمزيد.",
    orderSubText3:
      "قم بتنزيل تطبيق Joylo اليوم، وحقق كل رغبة في تناول الطعام إلى حقيقة لذيذة.",
    ...
    vendorDescription:
      "وسع نطاق وصولك، واجذب المزيد من العملاء، وابنِ روابط أقوى في كل حي. انضم إلى Joylo كبائع اليوم!",
    ...
    emailConfirmationDescription:
      "نحن متحمسون لانضمامك إلينا حيث نسعى لتحسين خدمة التوصيل للجميع. كشريك توصيل/استلام، يمكنك العمل وفقًا لجدولك الزمني في أي وقت وأي مكان. تحتاج إلى مساعدة؟ أرسل لنا بريدًا إلكترونيًا على joylogifts@gmail.com",
    getStarted: "ابدأ الآن",
    thankyouPageHeading: "تم إرسال بريدك الإلكتروني بنجاح!",
    thankyouPageDescription:
      "سيتواصل معك أحد أعضاء فريقنا قريبًا لمساعدتك في الإعداد والإجابة على أي أسئلة قد تكون لديك. تحتاج إلى مساعدة؟ أرسل لنا بريدًا إلكترونيًا على joylogifts@gmail.com",
