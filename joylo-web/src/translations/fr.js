const fr = {
  translation: {
    ...
    footerText:
      "Joylo est une plateforme open source de gestion des livraisons pour le avenir. Nous accordons la priorité à l innovation, à la flexibilité et à l abordabilité, et offrez une solution évolutive et personnalisable qui rationalise votre processus de livraison.",
    footerLinkHome: "Accueil",
    footerLinkPP: "Politique de confidentialité",
    footerLinkTC: "Conditions générales",
    footerEndText: "Joylo - © 2022 Tous droits réservés",
    ...
    createAccount: "Créez votre compte Joylo",
    ...
    vendorDescription:
      "Étendez votre portée, attirez plus de clients et créez des liens plus forts dans chaque quartier. Rejoignez Joylo en tant que vendeur dès aujourd’hui!",
