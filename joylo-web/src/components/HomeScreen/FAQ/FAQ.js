      ...
      <Grid container item xs={12} className={classes.FAQContainer}>
        ...
        <Grid container item xs={10} sm={10} md={9}>
          <Typography variant="h4" className={classes.FAQTitle}>
            Order food online from the best restaurants and shops on Joylo
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
            Are you hungry? Had a long and busy day? Then Joylo is the right place for you! Joylo, offers you a long
            and detailed <b>list of the best restaurants near you</b>. Whether it is a delicious Pizza, Burger, Japanese
            or any kind of Fast Food you are craving, Joylo has an extensive roaster restaurants available for you to{" "}
          ...
          <Grid item xs={12}>
            <List disablePadding>
              ...
              <ListItem divider alignItems="flex-start" disableGutters style={{ padding: "0px", marginBottom: "10px" }}>
                ...
                <ListItemText primary="NEW: Joylo grocery delivery! Discover the best shops, pharmacies, bakeries and more near you." />
              </ListItem>
            </List>
          </Grid>
