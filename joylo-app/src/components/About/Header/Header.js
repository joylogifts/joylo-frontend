    ...
    <>
      ...
      <View style={styles(currentTheme).mainContainer}>
        <View style={styles().topBar}>
          ...
          <View>
            <TextDefault H4 bolder Center textColor={currentTheme.fontThirdColor} numberOfLines={1} ellipsizeMode='tail'>
              {props?.restaurantName?.length > 20 ? `${props?.restaurantName.slice(0, 15)}...` : props?.restaurantName}
            </TextDefault>
          </View>
